...
<head>
    ...
    <title>@yield('title', 'Admin - Iseki Part NG')</title>
    <meta name="description" content="Admin Panel - Iseki Part NG Management System">
    ...
    <style>
        ...
        * {
        ...
        /* Raise only the dropdown menu above the table so it is not covered,
           but keep it below the fixed sidebar (z-index 2000) so it never
...
<body>
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar-brand d-flex align-items-center">
            ...
            <div class="brand-text">Admin Panel<span class="d-block brand-sub">Iseki Part NG</span></div>
        </div>
        <nav class="app-sidebar-nav">
            ...
            <a class="nav-link {{ request()->routeIs('admin.report-unprocessed') ? 'active' : '' }}" href="{{ route('admin.report-unprocessed') }}">
        ...
        <div class="app-sidebar-footer">
            <div class="d-flex align-items-center gap-2 mb-2">
                ...
                <div class="flex-grow-1">
                    <div class="text-white small fw-semibold">{{ auth()->user()->Name_User ?? 'Admin' }}</div>
                    <div class="text-white-50" style="font-size:.65rem">Administrator</div>
                </div>
            </div>
        ...
        <footer class="footer-app">
            <div class="container-fluid px-lg-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div><i class="bi bi-shield-lock-fill me-2"></i>Iseki_Part_Ng — Iseki Indonesia {{ date('Y') }}</div>
