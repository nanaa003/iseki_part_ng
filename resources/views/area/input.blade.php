...
{{-- BUG FIX: @push harus di DALAM @section atau setelah @endsection, dan library wajib di-include --}}
@push('scripts')
<script>window.csrfToken = '{{ csrf_token() }}';</script>
{{-- BUG FIX: Library yang hilang di area view (ada di admin tapi tidak di area) --}}
