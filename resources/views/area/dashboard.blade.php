...
<div class="container py-4 fade-in">
    ...
    <div class="glass-card p-3 mb-4">
        <form action="{{ route('area.dashboard') }}" method="GET" class="row g-3 align-items-end">
            <div class="col-md-4">
                <label class="form-label small fw-bold" style="color: var(--pink-600);">Filter Tanggal</label>
            ...
            <div class="col-md-3">
                <label class="form-label small fw-bold" style="color: var(--pink-600);">Divisi</label>
            ...
            <div class="col-md-3">
                <label class="form-label small fw-bold" style="color: var(--pink-600);">Kategori</label>
                    ...
                    <tbody>
                        @forelse($parts as $index => $p)
                            <tr>
                                ...
                                <td>
                                    <div class="fw-bold" style="color: var(--pink-600);">{{ \Carbon\Carbon::parse($p->Date_Part_Ng)->format('H:i') }}</div>
                                ...
                                <td>
                                    <span class="small @if($p->penanggungjawab) fw-bold text-success @else text-muted fst-italic @endif">
                                        ...
                                        <i class="bi bi-person-check-fill me-1"></i>{{ $p->penanggungjawab }}
                                        @else
                                        -
                                        @endif
                                    </span>
