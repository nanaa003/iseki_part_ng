...
<div class="container-fluid px-lg-5 py-4 fade-in">
    <div class="d-flex justify-content-between align-items-end mb-4 flex-wrap gap-3 border-bottom pb-3 border-pink-200">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.report') }}" class="btn btn-outline-secondary shadow-sm rounded-pill px-4 py-2 fw-bold">
                <i class="bi bi-list-ul me-2"></i>Semua Report
            </a>
            <a href="{{ route('admin.report-unprocessed-monthly') }}" class="btn btn-outline-warning shadow-sm rounded-pill px-4 py-2 fw-bold">
    ...
    <div class="glass-card p-3 border-0 mb-4">
        <form action="{{ route('admin.report-processed-monthly') }}" method="GET" class="row g-2 align-items-end">
            <div class="col-auto">
...
<option value="DST" {{ request('divisi') == 'DST' ? 'selected' : '' }}>DST</option>
            ...
            <div class="col-auto">
                ...
                <a href="{{ route('admin.report-processed-monthly') }}" class="btn btn-light shadow-sm" style="border-radius:10px;font-size:.85rem;padding:.45rem 1.2rem;color:var(--pink-700);font-weight:600">Reset</a>
            </div>
    ...
    <div class="modal fade" id="processModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 glass-card">
                <div class="modal-header border-bottom-0 pb-0">
                    <h5 class="modal-title fw-bold" style="color:var(--pink-800)"><i class="bi bi-gear-fill me-2"></i>Edit Proses Part NG</h5>
