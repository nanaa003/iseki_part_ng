...
<div class="container-fluid px-lg-5 py-4 fade-in">
    ...
    <div class="glass-card p-3 border-0 mb-4">
        <form action="{{ route('admin.report-processed') }}" method="GET" class="row g-2 align-items-end">
            <div class="col-auto">
            ...
            <div class="col-auto">
                ...
                <a href="{{ route('admin.report-processed') }}" class="btn btn-light shadow-sm" style="border-radius:10px;font-size:.85rem;padding:.45rem 1.2rem;color:var(--pink-700);font-weight:600">Reset</a>
            </div>
...
<script>
    ...
    function saveProcess() {
        ...
        // Get penanggungjawab value based on selected radio
