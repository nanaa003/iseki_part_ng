...
<div class="container pb-5">
    <div class="mb-3">
        <a href="{{ route('admin.dashboard') }}" class="btn btn-pink-outline">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateCategoryHint() {
            ...
            if (cat == 'bukan tanggung jawab' && area.value) {
                hint.textContent = '→ Akan tersimpan sebagai: "bukan tanggung jawab ' + area.value + '"';
                hint.classList.remove('d-none');
            } else {
                hint.classList.add('d-none');
            }
        }
        document.getElementById('area').addEventListener('change', updateCategoryHint);
        ...
        document.getElementById('btnSubmit').addEventListener('click', function() {
            ...
            if (cat == 'bukan tanggung jawab') {
                finalCategory = 'bukan tanggung jawab ' + document.getElementById('area').value;
            }
