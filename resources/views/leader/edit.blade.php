...
<div class="container-fluid px-lg-5 py-4 fade-in">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            <h3 class="fw-bold mb-1" style="color:var(--ig800)">
    ...
    <div class="glass-card p-4 border-0">
        <form id="editForm" method="POST" action="{{ route('leader.part-ng.update', $part->Id_Part_Ng) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            <div class="row g-4">
                <div class="col-12">
                    <h6 class="fw-bold text-muted small text-uppercase mb-3" style="color:var(--ig700) !important">
                ...
                <div class="col-12">
                    <label class="form-label fw-bold small text-uppercase" style="color: var(--ig700);">
