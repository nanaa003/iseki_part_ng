...
<div class="container-fluid px-lg-5 py-4 fade-in">
    <div class="d-flex justify-content-between align-items-end mb-4 flex-wrap gap-3 border-bottom pb-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="{{ route('leader.ranking', ['month' => $prevMonth]) }}" class="btn btn-sm" style="border-radius:10px;padding:.5rem .7rem;background:var(--ig100);color:var(--ig700);border:1px solid var(--ig300);font-weight:600">
            ...
            <a href="{{ route('leader.ranking', ['month' => $nextMonth]) }}" class="btn btn-sm" style="border-radius:10px;padding:.5rem .7rem;background:var(--ig100);color:var(--ig700);border:1px solid var(--ig300);font-weight:600">
                        ...
                        <table class="table table-premium table-compact mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge" style="background:var(--ig100);color:var(--ig800);border:1px solid var(--ig200);font-size:0.8rem">
