...
<div class="container-fluid px-lg-5 py-4 fade-in">
    <div class="d-flex justify-content-between align-items-end mb-4 flex-wrap gap-3 border-bottom pb-3">
        <div>
            <h3 class="fw-800 mb-1" style="color:var(--ig800)">
                <i class="bi bi-check-circle-fill me-2 opacity-75"></i>Sudah Diproses
            </h3>
            <p class="text-muted mb-0">Data Part NG yang sudah diproses — {{ $monthLabel }}</p>
        </div>
    ...
    <div class="glass-card p-3 border-0 mb-4">
        <form action="{{ route('leader.report.processed') }}" method="GET" class="row g-2 align-items-end">
            <div class="col-auto">
                <label class="filter-label mb-1"><i class="bi bi-calendar me-1"></i>Bulan</label>
                <div class="input-group">
                    <button type="button" class="btn btn-sm btn-outline-secondary" style="border-radius:10px 0 0 10px;padding:.3rem .5rem;border-color:transparent;background:var(--ig100);color:var(--ig700);font-weight:600" onclick="navigateMonth(-1)"><i class="bi bi-chevron-left"></i></button>
                    ...
                    <button type="button" class="btn btn-sm btn-outline-secondary" style="border-radius:0 10px 10px 0;padding:.3rem .5rem;border-color:transparent;background:var(--ig100);color:var(--ig700);font-weight:600" onclick="navigateMonth(1)"><i class="bi bi-chevron-right"></i></button>
                </div>
            </div>
            <div class="col-auto">
            ...
            <div class="col-auto">
                ...
                <select name="divisi" class="form-select bg-light border-0 shadow-sm" style="border-radius:10px;font-size:.85rem">
                    ...
                    @foreach(\App\Models\Area::select('Divisi')->where('Divisi', '!=', 'Mower')->distinct()->orderBy('Divisi')->get() as $div)
            ...
            <div class="col-auto">
                ...
                <a href="{{ route('leader.report.processed') }}" class="btn btn-light shadow-sm" style="border-radius:10px;font-size:.85rem;padding:.45rem 1.2rem;color:var(--ig700);font-weight:600">Reset</a>
            </div>
    ...
    <div class="card glass-card border-0" style="border-radius:16px;overflow:hidden;box-shadow:0 10px 40px rgba(99,102,241,.08)">
        <div class="card-header card-header-pink d-flex justify-content-between align-items-center py-3">
            <h6 class="mb-0 fw-bold fs-6"><i class="bi bi-table me-2"></i>Daftar Part NG Sudah Diproses — {{ $monthLabel }}</h6>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="12" class="text-center py-5">
                                ...
                                <h6 class="fw-bold text-muted">Belum ada data yang diproses</h6>
